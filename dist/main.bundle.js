...
module.exports = "<div *ngIf=\"article\">\n\n    <div class=\"article-container\">\n            <div class=\"small-12 medium-3 columns\">\n                    <a routerLink=\"/edit/{{ article._id}}\" class=\"btns edit\">Edit Article</a>\n                    <a (click)=\"deleteArticle(article._id)\" class=\"btns delete\">Delete Article</a>\n            </div>\n            <div class=\"row expanded\">\n                <div class=\"small-12 medium-9 columns\">\n                    <a id=\"articleTitle\" routerLink=\"#\">{{ article.title }}</a>\n                    <p>{{ article.content }}</p>\n                </div>\n            </div>\n\n    </div>\n\n</div>"
...
module.exports = "<nav class=\"navbar navbar-toggleable-sm fixed-top navbar-inverse mb-4\" style=\"background-color:#5c2509;\">\n    <button class=\"navbar-toggler navbar-toggler-right\" type=\"button\" data-toggle=\"collapse\"\n            data-target=\"#main-nav\" aria-controls=\"main-nav\" aria-expanded=\"false\"\n            aria-label=\"Toggle navigation\">\n        <span class=\"navbar-toggler-icon\"></span>\n    </button>\n    <a class=\"navbar-brand\" href=\"#\">Chris Mazzochi Web Designs</a>\n    <div class=\"collapse navbar-collapse\" id=\"main-nav\">\n        <ul class=\"navbar-nav mr-auto\">\n            <li class=\"nav-item\"> \n                    <a routerLink=\"/\" class=\"add-btn\">Home</a>\n            </li>\n            <li class=\"nav-item\"> \n                <a routerLink=\"/create\" class=\"add-btn\">Add an Article</a>\n            </li>\n            <li class=\"nav-item\" class=\"add-btn\"> \n                <a href=\"http://phpwebapp-env.us-east-2.elasticbeanstalk.com/index.php\">PHP App</a>\n            </li>\n            <li class=\"nav-item\" class=\"add-btn\"> \n                <a href=\"https://mazzo-java-app.scalingo.io/\">Java App</a>\n            </li>\n            <li class=\"nav-item\" class=\"add-btn\"> \n                <a href=\"https://corridormdtest.azurewebsites.net/\">.NET App</a>\n            </li>\n        </ul>\n    </div>\n</nav>\n"
...
var PaintingDetailsComponent = (function () {
    function PaintingDetailsComponent() {
        this.onHide = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* EventEmitter */]();
        this.isHidden = true;
    }
    PaintingDetailsComponent.prototype.onClick = function () {
...
], PaintingDetailsComponent.prototype, "onHide", void 0);
...
var SearchComponent = (function () {
    ...
    SearchComponent.prototype.resetCurrentPainting = function () {
